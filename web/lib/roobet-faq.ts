...
export const faqData = [
  { q: "Is Roobet available in my country?", a: "Roobet blocks a long list of jurisdictions including the UK, the Netherlands, Australia and several US states. Its restricted list is published in the terms, and its geo-block is active — it blocked a request we sent from a restricted region — so check the list before depositing rather than after." },
  ...
  { q: "How fast are withdrawals really?", a: "4 min 12s is the median listed for Roobet on our index. We haven't timed withdrawals here ourselves yet — that's the first thing our field-test pass will confirm or correct." },
