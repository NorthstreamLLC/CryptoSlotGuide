...
export const faqData = [
  ...
  { q: "Does CryptoSlotGuide get paid for this review?", a: "We receive commission when a reader signs up through our links, including Roobet. Commission never changes what a review says, the methodology is published, and every operator on the index is reviewed on the same six criteria whether or not we have a commercial relationship with them." },
];
